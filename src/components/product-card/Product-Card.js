            ...
            <div className="h-72 md:cursor-pointerz">
                <div className=" h-full border shadow-sm rounded-md overflow-hidden">
                    ...
                    <div className="description-section w-full h-1/2 p-1 flex flex-col gap-1 justify-start overflow-hidden md:h-2/5">
                        <p className="product-name text-xs line-clamp-3 md:line-clamp-4">{this.props.name}</p>
                        <p className="product-name text-xs text-base font-semibold">{this.props.title}</p>
