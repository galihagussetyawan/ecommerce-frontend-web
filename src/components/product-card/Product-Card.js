        ...
        <div className="h-72 md:cursor-pointerz">
            <div className="w-32 h-full border shadow-sm rounded-md overflow-hidden md:w-48">
                ...
                <div className="image-section w-full h-1/2 md:h-3/5 overflow-hidden">
                    <img className="w-full h-full object-fill" src={props.imgSrc}></img>
                </div>

                <div className="description-section w-full h-1/2 p-1 flex flex-col gap-1 justify-start overflow-hidden md:h-2/5">
                    <p className="product-name text-xs line-clamp-3 md:line-clamp-4">{props.name}</p>
                    <p className="product-name text-xs text-base font-semibold">{props.title}</p>
