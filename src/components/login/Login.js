...
export default class Login extends Component {
    constructor(props) {
        ...
        this.onChnageUsername = this.onChnageUsername.bind(this);
                ...
                <div className="login-card w-full h-full md:w-1/4 md:h-3/5 rounded-md flex flex-col justify-center items-center bg-white">
                    ...
                    <div className="wrapper w-11/12 h-3/4 flex flex-col justify-center gap-5">
                        ...
                        <div className="section flex flex-col gap-2">
                            ...
                            <input className="w-full p-2 outline-none rounded-md border border-gray-300 focus:border-green-500" onChange={this.onChnageUsername}></input>
